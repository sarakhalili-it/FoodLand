      ...
      <div>
        <div className="flex justify-between items-center mb-14">
          <div className="flex-grow">
            ...
            <ul className="flex">
              <li className="pr-7 flex items-center gap-2">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
              ...
              <li className="px-7 flex items-center gap-2 border-l border-r border-black10">
                <svg
          ...
          <div className="flex flex-col justify-center items-center gap-1">
            <a
              ...
              className="w-14 h-14 rounded-full bg-primary inline-flex justify-center items-center"
            >
              <svg
                className="w-6 h-6 text-gray-800 dark:text-white"
                aria-hidden="true"
        ...
        <div className="flex justify-between gap-7 mb-11">
          <div className="w-8/12 h-600 rounded-3xl">
            <img
          ...
          <div className="bg-primary rounded-3xl w-4/12 h-600 p-8">
            <h2 className="font-Inter font-semibold text-2xl mb-2">
              Ingredients
            </h2>
            <ul>
              <li className="py-4 flex justify-between border-b border-black10">
                <span className="font-Inter font-medium text-lg text-black60">
                  soy sauce
                </span>{" "}
                <span className="font-Inter font-medium text-lg">3/4 cup</span>
              </li>
            </ul>
          </div>
        </div>
      </div>
      <p className="font-Inter text-base leading-7 text-black60 text-justify">
